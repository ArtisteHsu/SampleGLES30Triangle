/*
    This is practice of OpenGL ES 3.0 Programming Guide, Second Edition
    Chapter 2: Hello Triangle for Android
    Date: 2016/9/6
    Arthur: Chih Jen Hsu (Artiste Hsu)
 */

package com.example.mobile.samplegles30triangle;
